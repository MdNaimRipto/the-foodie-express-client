...
const Banner = () => {
    return (
        <div className=" h-80 md:h-[600px] my-8">
            <Carousel className='text-center container mx-auto'>
                <div className='banner-1 banner-design pb-12 md:pb-28'>
                ...
                <div className='banner-2 banner-design pb-12 md:pb-28'>
                ...
                <div className='banner-3 banner-design pb-12 md:pb-28'>
